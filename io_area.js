...
let io_area =
{
    ...
    setup : function()
    {
        ...
        this.select.div.appendChild(document.createTextNode(" 〜 "));
        this.select.stringy.div.onclick = function() { io_area.stringy_select(); };
        this.select.googly.div.onclick = function() { io_area.googly_select(); };

        this.mode = 'stringy';

    },

    return_stringy_text : function()
    {   return this.stringy.textarea.value;   },

    set_stringy_text : function (passed_string)
    {   this.stringy.textarea.value = passed_string;   },

    return_googly_text : function()
    {   return this.googly.textarea.value;   },

 /* when_input : function()
    {// let test_area = document.getElementById('test_area');
     // test_area.innerText = io_area_return_text();
 }, */

    beautify_text : function()
    {   io_area.set_text(JSON.stringify(JSON.parse(this.return_text()),null,2));
    },
    ...
    rainbow :
    {
        ...
        activate : function()
        {
            ...
            {   hue++;
                inverse_hue = hue+180;
                io_area.stringy.textarea.style.backgroundColor = "hsl(" + hue + ", 40%,  20%)";
    ...
    stringy :
    {
        setup : function()
        {
            ...
            this.rainbowtoggle.div.onclick = function() { io_area.rainbow.toggle(); };

            this.div.appendChild(document.createTextNode(" 〜 "));

            this.hide();
            io_area.div.appendChild(this.div);
